...
export default function GuidePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl bg-white p-5 shadow-warm">
        <h2 className="font-bold text-indigo-700">このアプリは何？</h2>
        <p className="mt-2 text-sm leading-relaxed text-stone-700">
      ...
      <section className="rounded-2xl bg-white p-5 shadow-warm">
        ...
        <div className="mt-3">
          ...
          <RankStep n={4} condition="問題プールの問題量が不十分で、演習できていない単元が多数残っていると想定される科目がある" action="1〜2件程度なら最もストックが薄い科目を科目別演習、3件以上と広範囲なら全科目演習" note="対象を絞れる場合は、その科目を訪れること自体がストック補充のきっかけになる" />
          <RankStep n={5} condition="間違えたまま残っている問題が多い苦手科目トップ3がある" action="科目別演習、または復習モード" note="判断材料が十分なら復習モード、不足していれば科目別演習を優先。ただし復習が60問以上溜まっていれば判断材料が少なくても復習モードを優先" />
          <RankStep n={6} condition="想起の庭の対象問題がある（30問以上）" action="想起の庭で忘れかけている問題を再テスト" note="克服済みの内容の定着確認であり、今も間違えている苦手科目トップ3の解消より優先度は低い（ただし連続提案は避ける）" />
